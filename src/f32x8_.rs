...
impl f32x8 {
    ...
    pub fn pow_f32x8(self, y: Self) -> Self {
        ...
        let overflow =
            cast::<_, f32x8>(ej.cmp_gt(i32x8::splat(0x0FF))) | (ee.cmp_gt(f32x8::splat(300.0)));
        let underflow =
            cast::<_, f32x8>(ej.cmp_lt(i32x8::splat(0x000))) | (ee.cmp_lt(f32x8::splat(-300.0)));
        ...
        let z = if xsign.any() {
            ...
            let z1 = yi.blend(z | yodd, self.cmp_eq(Self::ZERO).blend(z, Self::nan_pow()));
